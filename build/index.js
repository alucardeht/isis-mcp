...
server.tool("rag", "Busca web com extração inteligente de conteúdo (igual Apify RAG Web Browser)", {
    query: z
        .string()
...
server.tool("fetchFullContent", "Busca conteúdo completo de um resultado anterior de RAG obtido em contentMode=preview", {
    contentHandle: z
        .string()
        .min(1)
...
server.tool("scrape", "Extrai conteúdo inteligente de uma URL específica", {
    url: z
        .string()
        .url()
...
server.tool("screenshot", "Captura screenshot de uma página web", {
    url: z
        .string()
        .url()
